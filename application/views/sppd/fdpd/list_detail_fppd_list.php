...
<div id="div_add_fppd" class="j-panel">
	...
	<div id="div_tindakan" class="j-panel" data-content="TINDAKAN">
			...
			<table style="border-collapse: collapse;border: 1px solid #FFFFFF;" width="100%" id="table_perjalanan_dinas">
				<tr height="40px">
					<td width="20%">Pembatalan</td><td width="20%"> : </td><td width="2%"></td><td width="58%"></td>
				</tr>
				<tr height="40px">
					<td width="20%">Perpanjangan/Percepatan</td><td width="20%"> : </td><td width="2%"></td><td width="58%"></td>
				</tr>
				<tr height="40px">
