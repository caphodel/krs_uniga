<j-modal id="mdlEditKota" title="Tambah Tujuan" drag="true" mask="true" height="550px" width="550px">
	<div id="pop_up_add_tujuan">
		<table>
			<tr>
				<td>
					<j-combofield id="city" pk="5" class="inp_disable">Kota
						<j-table >
			...
			<tr>
				<td>
					<j-dateField id="departure_date" format="YYYY/MM/DD" class="inp_disable">Tanggal Berangkat</j-dateField>
				</td>
				<td>
					<j-timeField id="departure_time" class="inp_disable">Jam</j-timeField>
				</td>
			</tr>
			<tr>
				<td>
					<j-dateField id="arrival_date" format="YYYY/MM/DD" class="inp_disable">Tanggal Kembali</j-dateField>
				</td>
				<td>
					<j-timeField id="arrival_time" class="inp_disable">Jam</j-timeField>
				</td>
			</tr>
			<tr>
				<td colspan="2">
			...
			<tr>
				<td colspan="2">
					<j-textArea id="eff_date_note" class="inp_disable">Ket. Hari Efektif</j-textArea>
				</td>
			</tr>
			<tr height="50px">
				<td colspan="2">
...
<script>
	...
	function update_array(idx, obj){
		...
		$('#mdlEditKota').remove();
		array_eff_date.push(['<?php echo $_REQUEST['fppd_id']; ?>', '<?php echo $_REQUEST['destination_id']; ?>', obj.eff_date])
		reload_array_tujuan()
	}
